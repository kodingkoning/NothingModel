; version of NothingModel to vary communication and memory usage
globals [ list-size neighborhood-radius ] ; the number of elements put in the list and radius for neighborhood. Should be changed between experiments
...
Click setup and then go, or run headless.
...
https://github.com/kodingkoning/NothingModel
@#$#@#$#@
default
true
0
...
<experiments>
  <experiment name="comm_all2all" repetitions="1" runMetricsEveryStep="false">
    ...
    <go>all-to-all-comm
go</go>
    <postRun>show count patches</postRun>
